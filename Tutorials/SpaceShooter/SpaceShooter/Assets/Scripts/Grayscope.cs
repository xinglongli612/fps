...
public class Grayscope : MonoBehaviour
{
	...
	protected void OnGUI()
	{
		...
		GUILayout.Label("input.gyro.attitude: X " + Input.gyro.attitude.z);
		GUILayout.Label("iphone width/font: " + Screen.width + " : " + GUI.skin.label.fontSize+"x");
	}
